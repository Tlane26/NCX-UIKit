...
final class AuthManager {
    ...
    // This info should come for the backend
    struct Constants {
        static let clientID = "5cbc9e729bdc4cb7976feac9c83eb373"
        static let clientScret = "2e67b80914ad45b3862cf49a88d3bb99"
    ...
    public func exchangeCodeForToken(
        ...
        let task = URLSession.shared.dataTask(with: request){ [weak self] data, _, error in
            ...
            do {
                // if we dont know what the json will send back
