...
class FeaturedPlaylistCollectionViewCell: UICollectionViewCell {
    ...
    override func layoutSubviews() {
        ...
        creatorNameLabel.frame = CGRect(x: 3, y: contentView.height-60, width: contentView.width-6, height: 30)
        playlistNameLabel.frame = CGRect(x: 3, y: contentView.height-80, width: contentView.width-6, height: 30)
